...
import { Badge, EmptyState, SearchBar } from '../components/ui';
import { FileText, ChevronRight, Calendar, Filter } from 'lucide-react';
...
export const CitizenComplaints = () => {
  ...
  const loadData = useCallback(async () => {
    ...
    try {
      ...
      const complaintsRes = await apiFetch(`/api/complaints/${qs ? '?' + qs : ''}`);
